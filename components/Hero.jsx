...
const heroImages = [
  { src: 'https://source.unsplash.com/1600x900/?salon%2Cbeauty%2Celegant&sig=0',             label: 'Strength Training' },
  { src: 'https://source.unsplash.com/1600x900/?spa%2Cwellness%2Crelaxing&sig=1',                  label: 'Yoga & Meditation' },
  { src: 'https://source.unsplash.com/1600x900/?skincare%2Cbeauty%2Cclean&sig=2',                     label: 'Cardio Zone' },
  { src: 'https://source.unsplash.com/1600x900/?hair%2Csalon%2Cprofessional&sig=3',      label: 'Group Classes' },
];
      ...
      <div className="container hero-split">
        ...
        <div className="hero-content">
          <div className="hero-eyebrow">
            ...
            <span className="hero-sub-tag">Premium Fitness Center</span>
          </div>
        ...
        <div className="hero-visual">
          ...
          <div className="hero-float-badge">
            <span className="hero-float-num">CERT</span>
            <span className="hero-float-text">Certified Trainers</span>
          </div>
        </div>
      </div>
